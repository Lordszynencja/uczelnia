...
public class METest {
	...
	public static void main(String[] args) {
		...
		for (int i=1;i<=7;i++) {
			...
			RW.write("results"+dateFormatter.format(new Date())+".txt", sb.toString());
			Position.preparePermutations(i);
			Date d1 = new Date();
			long d01 = d1.getTime()-d0.getTime();
			System.out.println("permutations: " + d01/1000 + "." + numberFormat.format((int)d01%1000));
			sb.append(test(i)).append("\n");
			RW.write("results.txt", sb.toString());
			Date d2 = new Date();
			long d12 = d2.getTime()-d1.getTime();
			System.out.println("calculations: " + d12/1000 + "." + numberFormat.format((int)d12%1000));
		}
	}
}