...
public class Position {
	...
	public static Map<Position, Integer> positions = new HashMap<Position, Integer>();
	...
	public Integer calculate() {
		if (this.isOk()) {
			if (positions.get(this) == null) positions.put(this, new Integer(0));
			return new Integer(0);
		} else if (positions.get(this) != null) {
			...
			for (int[] p : permutations) {
				...
				Integer steps = positions.get(newPos);
				if (steps == null) {
